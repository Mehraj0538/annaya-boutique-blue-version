...
export function ImageUpload({ images, onChange, adminKey }: ImageUploadProps) {
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap gap-4 mb-4">
        {images.map((url, idx) => (
          <div
            key={idx}
            className="relative w-24 h-24 rounded-xl overflow-hidden group border border-slate-200"
          >
